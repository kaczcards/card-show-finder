      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl shadow-2xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            {showForgotPassword ? 'Reset your password' : 'Sign in to access the admin dashboard'}
          </p>
        </div>
        ...
        {resetEmailSent ? (
          <div className="mt-8">
            ...
            <button
              ...
              className="mt-4 w-full text-sm text-purple-600 hover:text-purple-500 underline"
            >
              Back to login
            </button>
          </div>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            Card Show Finder Admin Dashboard<br />
