...
console.warn(`Show ${_showId} is part of series ${showData.series_id}, claiming series instead`);
    ...
    console.error('Unexpected _error claiming show:', _err);
...
export const getOrganizerShows = async (
  ...
  try {
    ...
    console.error('Unexpected _error fetching organizer shows:', _err);
...
export const markShowAsSeriesParent = async (
  ...
  try {
    ...
    console.error('Unexpected _error marking show as series parent:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const addShowToSeries = async (
  ...
  try {
    ...
    console.error('Unexpected _error adding show to series:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const removeShowFromSeries = async (
  ...
  try {
    ...
    console.error('Unexpected _error removing show from series:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const getSeriesReviewScore = async (
  ...
  try {
    ...
    console.error('Unexpected _error getting series review score:', _err);
    return { data: null, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const updateShowExtraDetails = async (
  ...
  try {
    ...
    console.error('Unexpected _error updating show extra details:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const respondToReview = async (
  ...
  try {
    ...
    console.error('Unexpected _error responding to review:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const deleteReviewResponse = async (
  ...
  try {
    ...
    console.error('Unexpected _error deleting review response:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const sendBroadcastMessage = async (
  ...
  try {
    ...
    console.error('Unexpected _error sending broadcast message:', _err);
    return { success: false, error: err.message || 'An unexpected error occurred' };
  }
};
...
export const getBroadcastHistory = async (
  ...
  try {
    ...
    if (options._showId) {
      countQuery = countQuery.eq('show_id', options._showId);
    }
    ...
    if (options._showId) {
      query = query.eq('show_id', options._showId);
    }
    ...
    const history: BroadcastHistoryItem[] = data.map(_item => ({
      id: item.id,
      showId: item.show_id,
      showTitle: item.shows?.title,
      messageContent: item.message_content,
      sentAt: item.sent_at,
      recipients: _item.recipients || []
    }));

    return { data: history, error: null, count };
  } catch (err: any) {
    console.error('Unexpected _error fetching broadcast history:', _err);
...
export const getBroadcastQuota = async (
  ...
  try {
    ...
    console.error('Unexpected _error fetching broadcast quota:', _err);
    return { data: null, error: err.message || 'An unexpected error occurred' };
  }
};
