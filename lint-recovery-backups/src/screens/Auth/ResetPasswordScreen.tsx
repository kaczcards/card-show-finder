...
console.warn('[ResetPasswordScreen] Initial URL:', initialUrl);
        ...
        console.error('[ResetPasswordScreen] Error extracting token from URL:', _err);
...
console.warn('[ResetPasswordScreen] Password updated successfully');
      ...
      console.error('[ResetPasswordScreen] Error resetting password:', _err);
      setError(_err.message || 'Failed to reset password. Please try again.');
    } finally {
