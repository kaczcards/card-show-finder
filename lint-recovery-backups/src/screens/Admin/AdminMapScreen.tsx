...
const AdminMapScreen: React.FC = () => {
  ...
  const handleShowPress = (showId: string) => {
    const show = shows.find(s => s.id === _showId);
    if (show) {
    ...
    return (
      <View style={styles.centeredContainer}>
        ...
        <Text style={styles.errorMessage}>
          {_error || 'You do not have permission to access this page. Please contact an administrator.'}
        </Text>
        <TouchableOpacity 
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputRow}>
              ...
              <TextInput
                ...
                placeholder="Latitude (_e.g., 40.7128)"
              />
            </View>
            ...
            <View style={styles.inputRow}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                placeholder="Longitude (_e.g., -74.0060)"
              />
            </View>
