...
const MyShowsScreen: React.FC = () => {
   ...
   * (i._e., closest to today at the top of the list).
   */
   ...
   * (i._e., latest endDate at the top).  If endDate is missing,
  ...
  const renderUpcomingItem = ({ item }: { item: Show }) => (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <Text style={styles.cardTitle}>{_item.title}</Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        /* Always feed a freshly-sorted array so ordering updates
           automatically after any CRUD operations (_e.g. removal). */
        data={
          currentTab === 'upcoming'
