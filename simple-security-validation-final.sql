...
BEGIN
    ...
    IF failed_tests > 0 THEN
        ...
        FOR failed_test IN (SELECT test_name, details FROM security_validation_results WHERE NOT passed ORDER BY test_name) LOOP
            RAISE NOTICE '❌ %: %', failed_test.test_name, failed_test.details;
        END LOOP;
        RAISE NOTICE '================================================================';
    END IF;
