-- ================================================================
-- Fix: approve_pending_show Function
-- ================================================================
-- This fixes data type casting issues and adds better error handling
-- ================================================================
...
BEGIN
  ...
  BEGIN
    INSERT INTO public.shows (
      ...
      COALESCE(
        v_show_data->>'address', 
        v_show_data->>'city' || ', ' || v_show_data->>'state',
...
COMMENT ON FUNCTION public.approve_pending_show IS 
  'Approves a pending show and publishes it to the shows table with improved error handling';
