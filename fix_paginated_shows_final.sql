...
-- This script combines all prior fixes with proper location and date filtering
-- to ensure users only see shows within 25 miles and in the next 30 days

-- Drop the function to recreate it with the final version
DROP FUNCTION IF EXISTS public.get_paginated_shows;

-- Create the complete fixed function with proper filtering
...
3. Avoids GROUP BY issues by using a subquery approach
