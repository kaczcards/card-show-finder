-- Migration: Add description field to show approval
-- Description: Update approve_show_v2 to include description and other optional fields
...
COMMENT ON FUNCTION public.approve_show_v2 IS 'Approves a show with description, features, categories, and proper timezone handling';

SELECT '✅ Description and optional fields now included in show approval!' as result;
