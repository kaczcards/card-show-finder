-- Migration: 20250713010000_fix_paginated_shows_ambiguous_date.sql
-- Description: Fixes ambiguous column reference to start_date and end_date in the get_paginated_shows function
...
-- Create the function with fixed column references
