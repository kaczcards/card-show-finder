-- Migration: 20250711014500_create_paginated_shows_rpc.sql
-- Description: Creates an RPC function to fetch shows with pagination support,
-- including filtering by location, date range, and other criteria.

-- Drop the function if it already exists to ensure clean installation
DROP FUNCTION IF EXISTS public.get_paginated_shows;

-- Create the function with pagination support
