-- ================================================================
-- FIX FOR INFINITE RECURSION IN SHOW_PARTICIPANTS RLS POLICIES
-- ================================================================
-- This script fixes the infinite recursion issue in the show_participants
-- RLS policies by replacing the problematic policy with a non-recursive one.
--
...
-- policy definition.
--
-- Solution: Replace it with a policy that doesn't query the same table.
-- ================================================================
...
GRANT EXECUTE ON FUNCTION participates_in_show_safe(UUID) TO authenticated;

-- 6. Add comment explaining the fix
COMMENT ON POLICY "show_participants_select_mvp_dealer_fixed" ON show_participants IS 
