-- fixed-get-paginated-shows.sql
-- Purpose: Fix the get_paginated_shows function by removing the problematic GROUP BY clause
-- This corrected version properly aggregates results without GROUP BY

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS public.get_paginated_shows;

-- Create the get_paginated_shows function with proper parameter names
...
BEGIN
  ...
  -- Get the paginated results - FIXED: Removed GROUP BY clause
...
- Uses a WITH clause instead of GROUP BY to avoid SQL errors
