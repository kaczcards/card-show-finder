 ...
 */
export const _getShowById = async (id: string): Promise<Show | null> => {
  try {
 ...
 */
export const _deleteShow = async (id: string): Promise<boolean> => {
  try {
 ...
 */
export const _getFavoriteShows = async (userId: string): Promise<Show[]> => {
  try {
    const { data, error } = await supabase
      .from('user_favorites')
      .select('shows(*)')
 ...
 */
export const _getShowAttendees = async (showId: string): Promise<ShowAttendee[]> => {
  try {
    const { data, error } = await supabase
      .from('show_attendees')
      .select(`
 ...
 */
export const _getShowsByOrganizer = async (organizerId: string): Promise<Show[]> => {
  try {
    const { data, error } = await supabase
      .from('shows')
      .select('*')
 ...
 */
export const _getShowsAttendedByUser = async (userId: string): Promise<Show[]> => {
  try {
    const { data, error } = await supabase
      .from('show_attendees')
      .select('shows(*)')
